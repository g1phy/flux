...
from flux.util import configs, load_ae, load_clip, load_flow_model, load_t5, save_image_without_classifier
...
def main(
    ...
    attempt_count: int = 1,
    prompt: str = (
        "a photo of a very beautiful girl in forest with mist swirling around the tree trunks. The word "
        '"OLEG" is painted over it in big, red brush strokes with visible texture'
    ),
